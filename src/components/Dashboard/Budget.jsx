...
class Budgets extends Component {
            ...
            GetBudgets(true).then(response => {
                if (response) {
                    ...
                    if (response.length > 0) {
                        const defaultBudget = response.find(x => (x.default === 1 ? x : response[0]));
                        this.setState({budget: defaultBudget});
                    }
    ...
    render() {
        ...
        console.log("budget", budget, select);
                                ...
                                <tr>
                                    ...
                                    <td className="text-right">
                                        <span className="text-muted">
                                            {budget.last_update
                                                ? moment(budget.last_update).format("LLL")
                                                : null}
                                        </span>
                                    </td>
                                </tr>
                            ...
                            <tfoot>
                                <tr>
                                    <td className="text-right" colSpan="3">
                                        <Link to={{pathname: path}} className="font-italic">
