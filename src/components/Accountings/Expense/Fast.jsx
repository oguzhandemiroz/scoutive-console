...
export class Fast extends Component {
    ...
    handleSubmit = e => {
        e.preventDefault();
        const { uid, accounting_type, type, note, payment_date, amount, budget, player, employee } = this.state;
                                    ...
                                    <div className="col-12">
                                        <div className="form-group">
                                            ...
                                            <Select
                                                ...
                                                placeholder={
                                                    check_permissions.accounting_types ? "Seç..." : "Yetersiz yetki"
                                                }
                                                styles={
                                                ...
                                                isLoading={
                                                    check_permissions.accounting_types
                                                        ? select.accounting_types
                                                            ? false
                                                            : true
                                                        : false
                                                }
                                    ...
                                    <div className="col-sm-12 col-md-6 col-lg-6">
                                        <div className="form-group">
                                            ...
                                            <Select
                                                ...
                                                name="budget"
                                                placeholder={
                                                    check_permissions.budget ? "Kasa Seç..." : "Yetersiz yetki"
                                                }
                                                styles={
                                                ...
                                                isLoading={
                                                    check_permissions.budget ? (select.budgets ? false : true) : false
                                                }
                                                noOptionsMessage={value => `"${value.inputValue}" bulunamadı`}
