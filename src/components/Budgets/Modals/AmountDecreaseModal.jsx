...
export class AmountIncreaseModal extends Component {
    ...
    handleSubmit = e => {
        ...
        UpdateBudget({
            uid: uid,
            budget_id: bid,
            amount: parseFloat(amount.replace(",", ".")) * -1,
            note: note
        }).then(response => {
            if (response) {
                    ...
                    <form className="modal-dialog" role="document" onSubmit={this.handleSubmit}>
                        <div className="modal-content">
                            ...
                            <div className="alert alert-icon alert-warning border-radius-0">
                                ...
                                Kasa/Banka bakiye düzenlemek için olan para çıkışlarını ekleyin. Bu işlem Gelir veya
                                Gider'i etkilemez.
                            </div>
                            <div className="modal-body">
                                <div className="row">
                                    ...
                                    <div className="form-group col-12">
                                        <label className="form-label">Çıkarılacak Tutar</label>
                                        <input
                                            type="text"
