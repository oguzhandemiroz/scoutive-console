        ...
        const table = $("#rollcall-list").DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    createdCell: (td, cellData, rowData) => {
                        console.log(rowData.surname, rowData.is_scholarship);
                        const status_type = {
                        ...
                        if (cellData.is_scholarship === 0) {
                            ...
                            ReactDOM.render(
                                <span
                                    data-placement="top"
                                    data-content={`<b class="${status_type[3].color}">${status_type[3].text}</b> `}
                                    data-toggle="popover"
                                    className={`d-inline-flex justify-content-center align-items-center mr-1 badge ${status_type[3].badge}`}>
                                    <i className={`fa ${status_type[3].icon}`} />
                                </span>,
                                td
                            );
                        }
