								...
								<div>
									{cellData.fees.map((el, key) => {
										return (
											...
											`}
												data-toggle="popover"
												className={`d-inline-flex justify-content-center align-items-center mr-1 badge ${feeType[this.getPaidStatus(el.fee, el.amount)].badge}`}>
												<i
													className={`fe ${feeType[this.getPaidStatus(el.fee, el.amount)].icon}`}
												/>
											</span>
										);
									})}
