...
export class List extends Component {
            ...
            CreateRollcall({
                ...
                if (response) {
                    ...
                    if (status.code === 1020) {
                        ...
                        this.props.history.push(`/app/rollcalls/player/add/${response.rollcall_id}`);
    ...
    render() {
        const { rollcallList, loadingButton } = this.state;
        return (
            <>
                <div className="card">
                        ...
                        <div className="card-options">
                            {CheckPermissions(["r_write"]) && (
                                <button
                                    ...
                                    className={`btn btn-sm btn-success ${loadingButton}`}>
                                    Yoklama Oluştur
                                </button>
                            )}
                        </div>
