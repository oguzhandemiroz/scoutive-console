...
export class Salary extends Component {
    ...
    advancePaymentTabContent = (el, key) => {
        ...
        const findAdvancePayment = payAdvancePayments.filter(
            x => x.advance_payment_id === el.advance_payment_id
        );
                                            ...
                                            <div className="dimmer-content">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <DatePicker
                                                        ...
                                                        onChange={date =>
                                                            this.handleDate(date, "salary_date")
                                                        }
                                                ...
                                                <div className="row">
                                                    <div className="form-group col-6">
                                                        ...
                                                        <DatePicker
                                                            ...
                                                            dateFormat="dd/MM/yyyy"
                                                            onChange={date =>
                                                                this.handleDate(date, "paid_date")
                                                            }
                        ...
                        <div className="card">
                            <div className="card-header pr-3">
                                ...
                                <div
                                    ...
                                    role="group"
                                    aria-label="Salary History Tabs">
                                    <button
