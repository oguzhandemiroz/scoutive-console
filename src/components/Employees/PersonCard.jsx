							...
							<div className="dimmer-content">
								<div className="media mb-5">
									...
									<div className="media-body">
										...
										<p className="text-muted mb-0">{nullCheck(data.position)}</p>
								...
								<div className="form-group">
									...
									<div className="form-control-plaintext">{nullCheck(data.branch)}</div>
								</div>
								<div className="form-group">
								...
								<div className="form-group">
									...
									<div className="form-control-plaintext">{formatDate(data.start_date)}</div>
								</div>
								{data.end_date ? (
									<div className="form-group">
										<label className="form-label">İşten Ayrılma Tarihi</label>
										<div className="form-control-plaintext">{formatDate(data.end_date)}</div>
									</div>
								) : null}
							</div>
						</div>
