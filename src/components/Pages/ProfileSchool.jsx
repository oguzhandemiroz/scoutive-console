	...
	handleSubmit = e => {
		try {
			...
			if (formValid(requiredData)) {
				...
				formErrors.tax_office = tax_office ? (tax_office.length < 3 ? "is-invalid" : "") : "is-invalid";
									...
									<div className="dimmer-content">
										...
										<div className="form-group">
											...
											<Select
												...
												name="club"
												placeholder="Seç..."
												styles={formErrors.clubs === true ? customStylesError : customStyles}
												isClearable={true}
												isSearchable={true}
