							...
							<div className="d-flex order-lg-2 ml-auto">
									...
									<div className="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
										...
										>
											<span
												...
												style={{
													backgroundImage:
														"url(demo/faces/male/41.jpg)"
												}}
											/>
											<div>
												<strong>Nathan</strong> pushed
												new commit: Fix page load
												performance issue.
										...
										>
											<span
												...
												style={{
													backgroundImage:
														"url(demo/faces/female/1.jpg)"
												}}
											/>
											<div>
												<strong>Alice</strong> started
												new task: Tabler UI design.
												<div className="small text-muted">
													1 hour ago
												</div>
											</div>
										...
										>
											<span
												...
												style={{
													backgroundImage:
														"url(demo/faces/female/18.jpg)"
												}}
											/>
											<div>
												<strong>Rose</strong> deployed
												new version of NodeJS REST Api
												V3
												<div className="small text-muted">
													2 hours ago
												</div>
								...
								<div className="dropdown">
									...
									<div className="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
										...
										<a
											className="dropdown-item"
											href="javascript:sc.request.logout();"
										>
